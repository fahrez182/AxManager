...
public class SystemServiceHelper {
     ...
     * @deprecated Use {@link frb.axeron.api.AxeronBinderWrapper} instead
     */
    @Deprecated
    ...
    /**
     * Obtain a new data parcel for {@link frb.axeron.api.Axeron#transactRemote(Parcel, Parcel, int)} (Parcel, Parcel, int)}.
     *
