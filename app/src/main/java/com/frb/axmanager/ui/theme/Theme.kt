...
private val LightColorScheme = lightColorScheme(
    ...
    primaryContainer = PRIMARY_DARK.blend(Color.White, 0.6f),
    onPrimaryContainer = DARK_BLEND.blend(AMOLED_BLACK, 0.2f),
    //Secondary
    secondary = SECONDARY.blend(Color.White, 0.6f),
    onSecondary = SECONDARY.blend(AMOLED_BLACK, 0.8f),
    secondaryContainer = SECONDARY_DARK.blend(Color.White, 0.6f),
    onSecondaryContainer = DARK_BLEND.blend(AMOLED_BLACK, 0.2f),
    //Surface
    surface = DARK_BLEND.blend(Color.White, 0.8f),
    surfaceVariant = DARK_BLEND.blend(Color.White, 0.5f),
    surfaceContainer = DARK_BLEND.blend(Color.White, 0.9f),
    surfaceContainerLow = DARK_BLEND.blend(Color.White, 0.85f),
    surfaceContainerLowest = DARK_BLEND.blend(Color.White, 0.85f),
    surfaceContainerHigh = DARK_BLEND.blend(Color.White, 0.85f),
    surfaceContainerHighest = DARK_BLEND.blend(Color.White, 0.75f),
    errorContainer = RED.blend(Color.White, 0.5f),
    outline = DARK_BLEND.blend(Color.White, 0.1f),
    background = DARK_BLEND.blend(Color.White, 0.80f),
)
